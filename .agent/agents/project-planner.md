...
### Implementation Priority Order (BBr TFG)

| Priority | Phase | Agents | Focus |
|----------|-------|--------|-------|
| **P0** | **Data & ETL** | `backend-specialist` | Migrations, JCyL Open Data Sync, Models |
| **P1** | **API & Auth** | `backend-specialist` | Sanctum Setup, API Resources, Endpoints |
| **P2** | **Core UI** | `frontend-specialist` | Map Integration, Bar Cards, Filtering |
| **P3** | **Social** | `frontend-specialist` | Favorites, Reviews, User Profile |
| **P4** | **Polish** | `test-engineer` | Responsive Check, Email Testing |

> 🔴 **Dependency Rule:** Frontend can start scaffolding P2, but functional components wait for P1 API.
...
### 🟢 BBr PROJECT TYPE (HYBRID)

| Trigger | Project Type | Primary Agents |
|---------|--------------|----------------|
| **BBr Project** | **HYBRID** | `backend-specialist` (API/ETL) + `frontend-specialist` (UI/Map) |

> 🔴 **BBr Rule:**
> - Backend First: Set up Laravel + MariaDB + ETL Task
> - Frontend Second: Next.js reads from Laravel API
> - `mobile-developer` is NOT required (using Responsive Web).
...
#### 4. Rule Compliance (Manual Check - BBr)
- [ ] **Open Data Sync:** Tested and populates DB?
- [ ] **Map Interaction:** Pins appear and cluster?
- [ ] **Auth Flow:** Login/Register works with Laravel?
- [ ] **Email:** Welcome email sent on register?
- [ ] **Responsive:** Maps work on Mobile view?
